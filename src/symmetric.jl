function sym_lmul_fwd_impl!!(cdC, cdA, cdB)
...
function sym_rmul_fwd_impl!!(cdC, cdA, cdB)
    C, dC = primaltangent(cdC)
    A, dA = primaltangent(cdA)
    B, dB = primaltangent(cdB)
...
function sym_lmul_rev_impl!!(cdC, cdA, cdB)
    C, dC = primaltangent(cdC)
    A, dA = primaltangent(cdA)
    B, dB = primaltangent(cdB)
...
function sym_rmul_rev_impl!!(cdC, cdA, cdB)
    C, dC = primaltangent(cdC)
    A, dA = primaltangent(cdA)
    B, dB = primaltangent(cdB)
...
for ST in (HermSparse, SymSparse, ConjHermSparse, ConjSymSparse)
    ...
    @eval Mooncake.frule!!(::Dual{typeof(mul!)}, cdC::Dual{<:DenseVecOrMat}, cdA::Dual{<:$ST}, cdB::Dual{<:DenseVecOrMat}) = sym_lmul_fwd_impl!!(cdC, cdA, cdB)
    @eval Mooncake.rrule!!(::CoDual{typeof(mul!)}, cdC::CoDual{<:DenseVecOrMat}, cdA::CoDual{<:$ST}, cdB::CoDual{<:DenseVecOrMat}) = sym_lmul_rev_impl!!(cdC, cdA, cdB)

    @eval @is_primitive MinimalCtx Tuple{typeof(mul!), DenseMatrix{T}, DenseMatrix{T}, $ST{T, I}} where {T, I}
    @eval Mooncake.frule!!(::Dual{typeof(mul!)}, cdC::Dual{<:DenseMatrix}, cdA::Dual{<:DenseMatrix}, cdB::Dual{<:$ST}) = sym_rmul_fwd_impl!!(cdC, cdA, cdB)
    @eval Mooncake.rrule!!(::CoDual{typeof(mul!)}, cdC::CoDual{<:DenseMatrix}, cdA::CoDual{<:DenseMatrix}, cdB::CoDual{<:$ST}) = sym_rmul_rev_impl!!(cdC, cdA, cdB)
end
